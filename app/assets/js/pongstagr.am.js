...
+function ($) { 'use strict';
  ...
  Pongstgrm.prototype.template = {
    ...
    , remodal: function (options) {
        var remodal  = '<div class="remodal" data-remodal-id="triggr-'+ options.data.id +'">'
            remodal += '<img id="'+ options.data.id +'-full" src="'+ options.data.image +'" alt="'+ options.data.caption +'">'
            remodal += '</div>'
  ...
  Pongstgrm.prototype.stream = function () {
    ...
    function media (data, option) {
      $.each(data, function (a, b) {
        ...
        Pongstgrm.prototype.template.remodal (defaults)

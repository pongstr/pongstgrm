...
+function ($) { 'use strict';
  ...
  // Special plugin object for instances: @type {Object}
  $[pluginName] = { lookup: [] };

  // Get transition duration in ms: @return {Number}
  ...
  // Get a scrollbar width: @return {Number}
  ...
  Remodal.prototype.buildDOM = function () {
    ...
    !this.modal.hasClass(pluginName) &&
